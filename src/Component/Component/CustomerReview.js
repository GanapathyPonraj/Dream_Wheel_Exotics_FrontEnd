...
function CustomerReview() {
    ...
    //Constants
    const Reviews = [
        { Name: 'Emily Johnson', image: 'https://picjumbo.com/wp-content/uploads/woman-in-pink-coat-standing-next-to-a-supercar-free-photo.jpg', Rating: 4.8, Review: '"Absolutely amazing experience! The Lamborghini Huracan was a dream to drive, and the team at DreamWheels made the rental process so easy. I highly recommend this company for anyone looking to add a little excitement to their day."' },
